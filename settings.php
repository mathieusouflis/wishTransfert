...
<div class="h-410 w-561 gap-10 page-left">
    <div class="w-171 h-410 bg-white border-radius20 flex flex-col justify-between"></a>
        <div class="p-16">
            <a href="profile.php"><h3 class="w-full h-34 flex items-center text-15 text-black button-bg-gray h-34 gap-10"><?php icon("person") ?>Profile</h3>
            <h3 class="w-full h-34 flex items-center text-15 text-black bg-gray h-34 gap-10"><?php icon("link") ?>Links created</h3>
        </div>
